...
df$BMI <- round((df$BodyWeight/df$BodyLength^2)/1000, digits = 1) 
df$BSA_Du_Bois <- round(0.007184*(((df$BodyWeight^0.425))/1000)/(df$BodyLength)))) # Что-то напутал со скобками. Оригинал формулы BSA = 0.007184 × W^0.425 × H^0.725 W в килограммах 
